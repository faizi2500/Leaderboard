...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _showContent_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./showContent.js */ \"./src/showContent.js\");\n/* harmony import */ var _getInput_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getInput.js */ \"./src/getInput.js\");\n/* harmony import */ var _sendScores_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sendScores.js */ \"./src/sendScores.js\");\n/* harmony import */ var _getFromAPI_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./getFromAPI.js */ \"./src/getFromAPI.js\");\n/* harmony import */ var _createGame_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./createGame.js */ \"./src/createGame.js\");\n\n\n\n\n\n\n\nconst url = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/';\nlet newUrlWithGame;\nlet urlWithGame = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/K6M7cT3zpdPIl0p6GBmZ/scores/';\nconst submit = document.getElementById('submit-btn');\nconst refresh = document.getElementById('refresh-btn');\nconst newGame = document.getElementById('new-link');\nlet list = [];\n\nsubmit.addEventListener('click', async (e) => {\n  e.preventDefault();\n  const player = await (0,_getInput_js__WEBPACK_IMPORTED_MODULE_2__.default)();\n  const name = player.playerName;\n  const score = player.playerScore;\n  // const newGameData = score + name;\n  await (0,_sendScores_js__WEBPACK_IMPORTED_MODULE_3__.default)(name, score, urlWithGame);\n});\n\nrefresh.addEventListener('click', async (e) => {\n  e.preventDefault();\n  const getData = await (0,_getFromAPI_js__WEBPACK_IMPORTED_MODULE_4__.default)(urlWithGame);\n  const totalPlayers = getData.result;\n  // const newGame = getData.result;\n  list = totalPlayers;\n  (0,_showContent_js__WEBPACK_IMPORTED_MODULE_1__.default)(list);\n});\n\nnewGame.addEventListener('click', async (e) => {\n  e.preventDefault();\n  const result = await (0,_createGame_js__WEBPACK_IMPORTED_MODULE_5__.default)(url);\n  let gameID = result.result;\n  gameID = gameID.substring(14, 34);\n  newUrlWithGame = `${url}${gameID}/scores/`;\n  list = [];\n  console.log(newUrlWithGame);\n  urlWithGame = newUrlWithGame\n  console.log(urlWithGame)\n})\n\nwindow.onload = async () => {\n  console.log(newUrlWithGame);\n  console.log(urlWithGame);\n  const getData = await (0,_getFromAPI_js__WEBPACK_IMPORTED_MODULE_4__.default)(urlWithGame);\n  const totalPlayers = getData.result;\n  list = totalPlayers;\n  (0,_showContent_js__WEBPACK_IMPORTED_MODULE_1__.default)(list);\n};\n\n\n\n\n//# sourceURL=webpack://Leaderboard/./src/index.js?");
